...
| **`check_system_dependencies`** | _none_                                                                             | Checks if the host system has all required dependencies installed and returns a detailed list of installed and missing tools.                                    |
