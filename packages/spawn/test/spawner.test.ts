  ...
  for (const config of configs) {
    ...
    suite.d(suite.label, () => {
      ...
      if (process.platform === 'linux') {
        ...
        it.runIf(xvfbAvail)(
          `should spawn in Xvfb headless${xvfbAvail ? '' : ' [UNAVAILABLE: Xvfb missing]'}`,
          async () => {
            expect.hasAssertions();
        ...
        it.runIf(swayAvail)(
          `should spawn in sway headless${swayAvail ? '' : ' [UNAVAILABLE: sway missing]'}`,
          async () => {
            expect.hasAssertions();
        ...
        it.runIf(kwinAvail)(
          `should spawn in kwin headless${kwinAvail ? '' : ' [UNAVAILABLE: kwin missing]'}`,
          async () => {
            expect.hasAssertions();
