...
3. **Load Verification:** Ensure the font is fully loaded and registered with the canvas backend _before_ initializing the terminal grid or writing any ANSI data, as cell dimensions are calculated on initialization.
